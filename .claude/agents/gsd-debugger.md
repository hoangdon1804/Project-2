...
<required_reading>
@D:/project 2/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@D:/project 2/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/project 2/.claude
                  → checks D:/project 2/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/project 2/.claude/get-shit-done
                  → writes to D:/project 2/.claude/get-shit-done/hooks/
...
@D:/project 2/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/project 2/.claude/get-shit-done/references/common-bug-patterns.md
