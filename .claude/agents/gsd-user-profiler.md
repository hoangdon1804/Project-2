...
<reference>
@D:/project 2/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/project 2/.claude/get-shit-done/references/user-profiling.md` to load:
