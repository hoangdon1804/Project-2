...
Key references:
- @D:/project 2/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @D:/project 2/.claude/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/project 2/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/project 2/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "D:/project 2/.claude/get-shit-done/USER-PROFILE.md" "D:/project 2/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/project 2/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/project 2/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @D:/project 2/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to D:/project 2/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to D:/project 2/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/project 2/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/project 2/.claude/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to D:/project 2/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="D:/project 2/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    D:/project 2/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/project 2/.claude/commands/gsd/dev-preferences.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        D:/project 2/.claude/CLAUDE.md
```
