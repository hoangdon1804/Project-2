...
<template>
@D:/project 2/.claude/get-shit-done/templates/UAT.md
</template>
...
Read and follow `D:/project 2/.claude/get-shit-done/workflows/transition.md`.
...
```bash
node "D:/project 2/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @D:/project 2/.claude/get-shit-done/workflows/diagnose-issues.md
