...
```
Task(
  prompt="Read D:/project 2/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/project 2/.claude/get-shit-done/templates/VALIDATION.md`
