...
```markdown
Read D:/project 2/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/project 2/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/project 2/.claude/agents/gsd-ui-checker.md for instructions.
