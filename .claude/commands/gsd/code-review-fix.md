...
<execution_context>
@D:/project 2/.claude/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @D:/project 2/.claude/get-shit-done/workflows/code-review-fix.md end-to-end.
